  ...
  const COURSES = [
    { id: "pistol-1", level: "Beginner", title: "Handgun Essentials", badge: "Popular", duration: "4 hrs", price: 179, outline: ["Safety rules & range etiquette","Grip, stance, sight picture","Trigger control & follow‑through","Live‑fire fundamentals"]},
    { id: "pistol-2", level: "Intermediate", title: "Defensive Pistol", badge: "New", duration: "6 hrs", price: 279, outline: ["Drawstroke & presentation","Reloads & malfunction clears","Movement & use of cover","Timed drills & standards"]},
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {PRODUCTS.map(p => (
                <Card key={p.id} className="group bg-zinc-900/60 border-zinc-800 overflow-hidden">
                  <div className="aspect-[4/3] bg-[url('https://images.unsplash.com/photo-1614854262340-771683b95152?q=80&w=1600&auto=format&fit=crop')] bg-cover bg-center" />
